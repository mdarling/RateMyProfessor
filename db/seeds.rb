...
professors = [
	...
	{name: 'Adema', first_name: 'Coenraad', department: 'BIO' },
	{name: 'Bergthorsson', first_name: 'Ulfar', department: 'BIO' },
	{name: 'Charnov', first_name: 'Eric', department: 'BIO' },
	{name: 'Collins', first_name: 'Scott', department: 'BIO' },
	{name: 'Cook', first_name: 'Joseph', department: 'BIO' },
	{name: 'Adema', first_name: 'Coenraad', department: 'BIO' },
	{name: 'Couch', first_name: 'Lee', department: 'BIO' },
	{name: 'Council-Garcia', first_name: 'Cara Lea', department: 'BIO' },
	{name: 'Cripps', first_name: 'Richard', department: 'BIO' },
	{name: 'Cunningham', first_name: 'Charles', department: 'BIO' },
	{name: 'Dahm', first_name: 'Clifford', department: 'BIO' },
	{name: 'Fridrick', first_name: 'Christina', department: 'BIO' },
	{name: 'Hanson', first_name: 'David', department: 'BIO' },
	{name: 'Hofkin', first_name: 'Bruce', department: 'BIO' },
	{name: 'Howe', first_name: 'Kelly', department: 'BIO' },
	{name: 'Jognston', first_name: 'Christopher', department: 'BIO' },
	{name: 'Katju', first_name: 'Vaishali', department: 'BIO' },
	{name: 'Litvak', first_name: 'Marcy', department: 'BIO' },
	{name: 'Loker', first_name: 'Eric', department: 'BIO' },
	{name: 'Lowrey', first_name: 'Timothy', department: 'BIO' },
	{name: 'Marshall', first_name: 'Diane', department: 'BIO' },
	{name: 'Miller', first_name: 'Kelly', department: 'BIO' },
	{name: 'Miller', first_name: 'Robert', department: 'BIO' },
	{name: 'Milne', first_name: 'Bruce', department: 'BIO' },
	{name: 'Natvig', first_name: 'Donald', department: 'BIO' },
	{name: 'Nelson', first_name: 'Mary Anne', department: 'BIO' },
	{name: 'Pockman', first_name: 'William', department: 'BIO' },
	{name: 'Poe', first_name: 'Steven', department: 'BIO' },
	{name: 'Pontes', first_name: 'Olga', department: 'BIO' },
	{name: 'Rudgers', first_name: 'Jennifer', department: 'BIO' },
	{name: 'Salinas', first_name: 'Irene', department: 'BIO' },
	{name: 'Schmidly', first_name: 'David', department: 'BIO' },
	{name: 'Shaner', first_name: 'Marieken', department: 'BIO' },
	{name: 'Sinsabaugh', first_name: 'Robert', department: 'BIO' },
	{name: 'Smith', first_name: 'Felisa', department: 'BIO' },


	{name: 'Allen', first_name: 'Richard', department: 'MATH' },
	{name: 'Andrew', first_name: 'Precious', department: 'MATH' },
	{name: 'Appelo', first_name: 'Daniel', department: 'MATH' },
	{name: 'Ash', first_name: 'John', department: 'MATH' },
	{name: 'Bedrick', first_name: 'Edward', department: 'MATH' },
	{name: 'Berkopec', first_name: 'Timothy', department: 'MATH' },
	{name: 'Bevis', first_name: 'William', department: 'MATH' },
	{name: 'Bilisoly', first_name: 'Roger', department: 'MATH' },
	{name: 'Blair', first_name: 'Matthew', department: 'MATH' },
	{name: 'Bolli', first_name: 'Jurg', department: 'MATH' },
	{name: 'Boyer', first_name: 'Charles', department: 'MATH' },
	{name: 'Brackbill', first_name: 'Jeremiah', department: 'MATH' },
	{name: 'Brewer', first_name: 'Dann', department: 'MATH' },
	{name: 'Briand', first_name: 'Cathy', department: 'MATH' },
	{name: 'Brooks', first_name: 'Dusty', department: 'MATH' },
	{name: 'Brown', first_name: 'William', department: 'MATH' },
	{name: 'Buium', first_name: 'Alexandru', department: 'MATH' },
	{name: 'Burns', first_name: 'Kevin', department: 'MATH' },
	{name: 'Burridge', first_name: 'Robert', department: 'MATH' },
	{name: 'Buser', first_name: 'Pascal', department: 'MATH' },
	{name: 'Cameron', first_name: 'Laura', department: 'MATH' },
	{name: 'Casson', first_name: 'Deborah', department: 'MATH' },
	{name: 'Champine', first_name: 'Karen', department: 'MATH' },
	{name: 'Cherepanov', first_name: 'Pavlo', department: 'MATH' },
	{name: 'Christensen', first_name: 'Ronald', department: 'MATH' },
	{name: 'Chung', first_name: 'Daewon', department: 'MATH' },
	{name: 'Cogburn', first_name: 'Robert', department: 'MATH' },
	{name: 'Coke', first_name: 'Sterling', department: 'MATH' },
	{name: 'Coutsias', first_name: 'Evangelos', department: 'MATH' },
	{name: 'Davis', first_name: 'Jeffrey', department: 'MATH' },
	{name: 'Defilippo', first_name: 'Charles', department: 'MATH' },
	{name: 'Ediger', first_name: 'Cynthia', department: 'MATH' },
	{name: 'Ellison', first_name: 'James', department: 'MATH' },
	{name: 'Falkovich', first_name: 'Gregory', department: 'MATH' },
	{name: 'Fanelli', first_name: 'Dominic', department: 'MATH' },
	{name: 'Gans', first_name: 'Claudia', department: 'MATH' },
	{name: 'Gibson', first_name: 'Archie', department: 'MATH' },
	{name: 'Harris', first_name: 'Cliff', department: 'MATH' },
	{name: 'Heinemann', first_name: 'Klaus', department: 'MATH' },
	{name: 'Schrader', first_name: 'Ronald', department: 'MATH' },
	{name: 'Vigil', first_name: 'Rey', department: 'MATH' },
	{name: 'Wearing', first_name: 'Helen', department: 'MATH' },
	{name: 'White', first_name: 'Bryan', department: 'MATH' },
	{name: 'Zhou', first_name: 'Lang', department: 'MATH' },
